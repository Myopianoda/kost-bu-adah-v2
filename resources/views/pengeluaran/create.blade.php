                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('pengeluaran.store') }}">
                        ...
                        <div>
                            ...
                            <input id="keterangan" class="block mt-1 w-full" type="text" name="keterangan" :value="old('keterangan')" required autofocus />
                        </div>

                        <div class="mt-4">
                            <label for="jumlah" class="block font-medium text-sm text-gray-700">Jumlah (Rp)</label>
                            <input id="jumlah" class="block mt-1 w-full" type="number" name="jumlah" :value="old('jumlah')" required />
                        </div>

                        <div class="mt-4">
                            <label for="tanggal" class="block font-medium text-sm text-gray-700">Tanggal Pengeluaran</label>
                            <input id="tanggal" class="block mt-1 w-full" type="date" name="tanggal" :value="old('tanggal', date('Y-m-d'))" required />
                        </div>
