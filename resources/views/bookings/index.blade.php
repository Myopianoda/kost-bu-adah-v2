                                ...
                                @forelse ($bookings as $booking)
                                    <tr class="hover:bg-gray-50 transition duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            @else
                                            {{-- Jika status sudah Diterima/Ditolak/Expired, boleh dihapus dari list --}}
                                            <div class="flex justify-end">
                                                <form action="{{ route('bookings.destroy', $booking->id) }}" method="POST" onsubmit="return confirm('Yakin hapus riwayat booking ini?');">
                                                    @csrf
                                                    @method('DELETE')
